...
func ExampleDecodeTime() { // nolint:govet
	...
	// struct initially.
	birth := time.Date(2020, 1, 24, 0, 0, 0, 0, time.UTC)
	birthString := birth.Format(time.RFC3339Nano)
	...
	fmt.Println(result.Birth.Format(time.RFC3339Nano))
	// Output:
...
func ExampleDecode_weaklyTypedInput() {
	...
	fmt.Printf("%#v", result)
	// Output: mapstruct.Person{Name:"123", Age:42, Emails:[]string{}}
}
