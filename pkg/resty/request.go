...
//
// See `Client.SetTrace` available too to get trace info for all requests.
func (r *Request) SetTrace(trace bool) *Request {
	r.trace = trace
	return r
}

// TraceInfo method returns the trace info for the request.
// If either the Client or Request SetTrace function has not been called
...
func (r *Request) Get(url string) (*Response, error) { return r.Execute(http.MethodGet, url) }

// Head method does HEAD HTTP request. It's defined in section 4.3.2 of RFC7231.
func (r *Request) Head(url string) (*Response, error) { return r.Execute(http.MethodHead, url) }

// Post method does POST HTTP request. It's defined in section 4.3.3 of RFC7231.
func (r *Request) Post(url string) (*Response, error) { return r.Execute(http.MethodPost, url) }

// Put method does PUT HTTP request. It's defined in section 4.3.4 of RFC7231.
func (r *Request) Put(url string) (*Response, error) { return r.Execute(http.MethodPut, url) }

// Delete method does DELETE HTTP request. It's defined in section 4.3.5 of RFC7231.
func (r *Request) Delete(url string) (*Response, error) { return r.Execute(http.MethodDelete, url) }

// Options method does OPTIONS HTTP request. It's defined in section 4.3.7 of RFC7231.
func (r *Request) Options(url string) (*Response, error) { return r.Execute(http.MethodOptions, url) }

// Patch method does PATCH HTTP request. It's defined in section 2 of RFC5789.
func (r *Request) Patch(url string) (*Response, error) { return r.Execute(http.MethodPatch, url) }
...
func (r *Request) Send() (*Response, error) { return r.Execute(r.Method, r.URL) }
...
func (r *Request) Execute(method, url string) (*Response, error) {
	...
	if r.isMultiPart && !(method == http.MethodPost || method == http.MethodPut || method == http.MethodPatch) {
