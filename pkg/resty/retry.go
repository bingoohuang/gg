...
func Retries(v int) Option { return func(o *Options) { o.maxRetries = v } }

// WaitTime sets the default wait time to sleep between requests
func WaitTime(v time.Duration) Option { return func(o *Options) { o.waitTime = v } }

// MaxWaitTime sets the max wait time to sleep between requests
func MaxWaitTime(v time.Duration) Option { return func(o *Options) { o.maxWaitTime = v } }
