...
func Test_read_int32(t *testing.T) {
	...
	for _, input := range inputs {
		...
		t.Run(fmt.Sprintf("%v", input), func(t *testing.T) {
			should := require.New(t)
			iter := jsoni.Parse(jsoni.ConfigDefault, bytes.NewBufferString(input), 2)
			expected, err := strconv.ParseInt(input, 10, 32)
			should.Nil(err)
			should.Equal(int32(expected), iter.ReadInt32())
		})
...
func Test_read_int_overflow(t *testing.T) {
	...
	for _, s := range inputArr {
		iter := jsoni.ParseString(jsoni.ConfigDefault, s)
		iter.ReadInt8()
		should.NotNil(iter.Error)

		iterU := jsoni.ParseString(jsoni.ConfigDefault, s)
		iterU.ReadUint8()
	...
	for _, s := range inputArr {
		...
		iterUint := jsoni.ParseString(jsoni.ConfigDefault, s)
		iterUint.ReadUint16()
...
func Test_write_uint8(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoni.NewStream(jsoni.ConfigDefault, buf, 3)
	stream.WriteRaw("a")
...
func Test_write_int8(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoni.NewStream(jsoni.ConfigDefault, buf, 4)
	stream.WriteRaw("a")
...
func Test_write_uint16(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoni.NewStream(jsoni.ConfigDefault, buf, 5)
	stream.WriteRaw("a")
...
func Test_write_int16(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoni.NewStream(jsoni.ConfigDefault, buf, 6)
	stream.WriteRaw("a")
...
func Test_write_uint32(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoni.NewStream(jsoni.ConfigDefault, buf, 10)
	stream.WriteRaw("a")
...
func Test_write_int32(t *testing.T) {
	...
	should := require.New(t)
	buf := &bytes.Buffer{}
	stream := jsoni.NewStream(jsoni.ConfigDefault, buf, 11)
	stream.WriteRaw("a")
