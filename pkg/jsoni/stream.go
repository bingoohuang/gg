...
// cfg can be jsoni.ConfigDefault.
...
func (s *Stream) Pool() StreamPool { return s.cfg }
...
func (s *Stream) Available() int { return cap(s.buf) - len(s.buf) }
...
// SetBuffer allows appending to the internal buffer directly
func (s *Stream) SetBuffer(buf []byte) { s.buf = buf }
...
func (s *Stream) WriteNil() { s.write4Bytes('n', 'u', 'l', 'l') }

// WriteTrue write true to stream
func (s *Stream) WriteTrue() { s.write4Bytes('t', 'r', 'u', 'e') }

// WriteFalse write false to stream
func (s *Stream) WriteFalse() { s.write5Bytes('f', 'a', 'l', 's', 'e') }
