...
func Test_any_to_string(t *testing.T) {
	...
	var val string
	should.Nil(jsoni.UnmarshalFromString(`"100"`, &val))
	should.Equal("100", val)
	should.Nil(jsoni.UnmarshalFromString("10", &val))
	should.Equal("10", val)
	should.Nil(jsoni.UnmarshalFromString("10.1", &val))
	should.Equal("10.1", val)
	should.Nil(jsoni.UnmarshalFromString(`"10.1"`, &val))
	should.Equal("10.1", val)
	should.NotNil(jsoni.UnmarshalFromString("{}", &val))
	should.NotNil(jsoni.UnmarshalFromString("[]", &val))
}
...
func Test_any_to_int64(t *testing.T) {
	...
	should.Nil(jsoni.UnmarshalFromString(`10`, &val))
	should.Equal(int64(10), val)
	should.Nil(jsoni.UnmarshalFromString(`""`, &val))
	should.Equal(int64(0), val)

	// bool part
	should.Nil(jsoni.UnmarshalFromString(`false`, &val))
	should.Equal(int64(0), val)
	should.Nil(jsoni.UnmarshalFromString(`true`, &val))
	...
	should.NotNil(jsoni.UnmarshalFromString("[]", &val))
	// large float to int
	should.NotNil(jsoni.UnmarshalFromString(`1234512345123451234512345.0`, &val))
}
...
func Test_any_to_uint64(t *testing.T) {
	...
	// TODO fix?
	should.NotNil(jsoni.UnmarshalFromString(`-10`, &val))
	should.Equal(uint64(0), val)
	should.NotNil(jsoni.UnmarshalFromString("{}", &val))
	should.NotNil(jsoni.UnmarshalFromString("[]", &val))
	// large float to int
...
`
	...
	err := jsoni.UnmarshalFromString(jsonstr, &a)
	should := require.New(t)
	should.Nil(err)
}
...
func Test_null_to_string(t *testing.T) {
	...
	body := []byte(`null`)
	var message string
	err := jsoni.Unmarshal(body, &message)
	should.NoError(err)
}
