...
func Test_read_empty_array_as_any(t *testing.T) {
	...
	any := jsoni.Get([]byte("[]"))
	should.Equal(jsoni.ArrayValue, any.Get().ValueType())
	should.Equal(jsoni.InvalidValue, any.Get(0.3).ValueType())
	should.Equal(0, any.Size())
	should.Equal(jsoni.ArrayValue, any.ValueType())
...
func Test_array_lazy_any_get_all(t *testing.T) {
	...
	any = jsoni.Get([]byte("[[[1],[2],[3,4]]]"), 0, '*', 0)
	should.Equal("[1,2,3]", any.ToString())
}
...
func Test_array_lazy_any_get_invalid(t *testing.T) {
	should := require.New(t)
	any := jsoni.Get([]byte("[]"))
	should.Equal(jsoni.InvalidValue, any.Get(1, 1).ValueType())
...
func Test_invalid_array(t *testing.T) {
	should := require.New(t)
	any := jsoni.Get([]byte("["), 0)
	should.Equal(jsoni.InvalidValue, any.ValueType())
}
