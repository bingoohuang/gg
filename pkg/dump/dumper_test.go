...
func TestDump_Basic(t *testing.T) {
	...
	assert.Contains(t, str, "github.com/bingoohuang/gg/pkg/dump.TestDump_Basic(dumper_test.go")
...
func TestMap_Simpled(t *testing.T) {
	...
	/*
		Output:
		PRINT AT github.com/bingoohuang/gg/pkg/dump.TestMap_Simpled(dump_test.go:309)
		map[int]int {
		  24: int(13),
		  23: int(12),
		}
	...
	*/
	...
	Print(m4)
	/*
		PRINT AT github.com/bingoohuang/gg/pkg/dump.TestMap_Simpled(dump_test.go:335)
...
func TestStruct_WithNested(t *testing.T) {
	...
	dumper.Println(s1)
	// OUT:
	// PRINT AT github.com/bingoohuang/gg/pkg/dump.TestStruct_WithNested(dump_test.go:223)
	...
	// Output:
	// PRINT AT github.com/bingoohuang/gg/pkg/dump.TestStruct_WithNested(dump_test.go:257)
	// dump.st2 {
	//  st1: dump.st1 {
	//    st0: dump.st0 {
	//      Sex: int(2),
	...
	// Output:
	// PRINT AT github.com/bingoohuang/gg/pkg/dump.TestStruct_WithNested(dump_test.go:278)
